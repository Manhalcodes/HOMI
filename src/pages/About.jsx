...
export default function About() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-50 to-pink-50 p-6 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8 border border-orange-100">
          ...
          <div className="bg-orange-50 p-6 rounded-xl mb-6 border-l-4 border-orange-400">
